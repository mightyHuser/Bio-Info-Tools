...
${pdfText.slice(0, 5000)}`,
      ...
      ollamaChat(
        'あなたは学術発表の聴衆です。発表者に鋭い質問をしてください。必ず日本語で回答してください。',
        `以下は学術発表のスライド内容です。この発表を聞いた聴衆として、発表者本人に直接聞きたい質問を5〜8個考えてください。

条件:
- 発表者に向けた質問（「あなたは〜ですか？」「この研究では〜でしょうか？」の形式）
- 発表の内容・手法・結果・考察に踏み込んだ具体的な質問
- 各質問は必ず「？」で終わること
- 質問のみを1行に1つ出力すること（説明・番号・箇条書き記号は不要）
